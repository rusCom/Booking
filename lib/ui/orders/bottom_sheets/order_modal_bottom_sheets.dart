...
class OrderModalBottomSheets {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            OrderWishesBabySeats(
                                orderBabySeats: orderWishes.orderBabySeats, onChanged: (value) => orderWishes.orderBabySeats = value),
                            OrderWishesSwitch(
  ...
  static orderDate(BuildContext context) {
    DateTime choseDateTime = DateTime.now().add(const Duration(minutes: 46));
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: CupertinoDatePicker(
                  minimumDate: DateTime.now().add(const Duration(minutes: 45)),
                  initialDateTime: DateTime.now().add(const Duration(minutes: 46)),
                  use24hFormat: true,
