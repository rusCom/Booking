...
class OrderBabySeats {
  ...
  final int _maxBabySeats = Preferences().wishesBabySeatsCount;

  Text? get subtitle {
    if (_babySeat0010 == 2) {
      return const Text("Две люльки до 10 кг");
    }
    if (_babySeat0918 == 2) {
      return const Text("Два кресла от 9 до 18 кг");
    }
    if (_babySeat1525 == 2) {
      return const Text("Два кресла от 15 до 25 кг");
    }
    if (_babySeat2236 == 2) {
      return const Text("Два бустера от 22 до 36 кг");
    }

    if (getCount() == 1) {
      if (_babySeat0010 == 1) {
        return const Text("Люлька до 10 кг");
      }
      if (_babySeat0918 == 1) {
        return const Text("Кресло от 9 до 18 кг");
      }
      if (_babySeat1525 == 1) {
        return const Text("Кресло от 15 до 25 кг");
      }
      if (_babySeat2236 == 1) {
        return const Text("Бустер от 22 до 36 кг");
      }
    }
    ...
    if (getCount() == 2) {
      return const Text("Два кресла от 9 до 18 и от 15 до 25 кг");
    }
